...
exports.DualSurfaceModel = exports.RiskScorer = exports.Greeks = exports.WidthDelta = exports.BumpFunctions = exports.SVI = void 0;
...
class SVI {
     ...
     */
    static fromMetrics(metrics, config, options) {
        const eps = 1e-12;
...
class WidthDelta {
     ...
     */
    static getPCMid(node, widthNow, ccMid, staleHours = 24) {
        if (node.position === 0) {
...
class Greeks {
     ...
     */
    static delta(strike, spot, vol, T, isCall = false) {
        if (T <= 0)
            return 0;
...
class RiskScorer {
    ...
    updateFromMarket(observations) {
        ...
        // Update floor
        this.betas.set('floor', alpha * avgSpread * 0.5 + (1 - alpha) * this.betas.get('floor'));
        this.lastUpdate = Date.now();
    }
    /**
...
class DualSurfaceModel {
     ...
     */
    onTrade(expiry, strike, price, size, spot) {
...
exports.DualSurfaceModel = DualSurfaceModel;
// ============================================================================
