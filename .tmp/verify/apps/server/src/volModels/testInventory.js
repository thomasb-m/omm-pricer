...
function runInventoryTest() {
    ...
    const controller = new inventoryController_1.InventoryController(config);
    // ===== Test 1: Edge Ladder =====
    ...
    for (const pos of positions) {
        const edge = inventoryController_1.EdgeLadder.calculateEdge(pos, config, 'rr25');
    ...
    for (const bucket of buckets) {
        const e = inventoryController_1.EdgeLadder.calculateEdge(testVega, config, bucket);
